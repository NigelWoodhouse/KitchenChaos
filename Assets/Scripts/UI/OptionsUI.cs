...
public class OptionsUI : MonoBehaviour
{
    ...
    {
        soundEffectsText.text = "SOUND EFFECT: " + Mathf.Round(SoundManager.Instance.GetVolume() * 10f).ToString();
    ...
    public void Show(Action onCloseButtionAction)
    {
        this.onCloseButtonAction = onCloseButtionAction;
